...
DEFAULT_RUNS_ROOT = Path("src/strategies/exper_corr_neg/reports/runs")
CONFIG_PATH = Path("src/strategies/exper_corr_neg/config.json")
SCOREBOARD_PATH = Path("src/strategies/exper_corr_neg/reports/train/pop/scoreboard.json")
CHECKPOINT_PATH = Path("src/strategies/exper_corr_neg/reports/train/moe_policy_final.pt")
