...
def main() -> None:
    ...
    outdir = Path(train_cfg.get("outdir", "src/strategies/exper_corr_neg/reports/train"))
    ...
    plot_usage(outdir, metrics_path, int(model_cfg.get("num_experts", 6)), usage_window)
